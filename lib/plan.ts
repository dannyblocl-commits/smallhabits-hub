...
export const PLANS: Record<Exclude<Plan, "free">, { name: string; price: string; tagline: string; features: string[]; envKey: string }> = {
  basico: {
    name: "Básico", price: "$12.99", tagline: "Entrena y come bien",
  ...
  pro: {
    name: "Pro", price: "$29.99", tagline: "Con tu reloj y tu coach",
  ...
  elite: {
    name: "Elite", price: "$129.99", tagline: "Transformación guiada",
